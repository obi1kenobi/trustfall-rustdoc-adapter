...
$( \
    curl \
        -A "trustfall-rustdoc-adapter is_version_already_uploaded.sh (https://github.com/obi1kenobi/trustfall-rustdoc-adapter/)" \
        2>/dev/null "https://crates.io/api/v1/crates/$CRATE_NAME" | \
